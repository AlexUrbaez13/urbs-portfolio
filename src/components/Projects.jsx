  ...
  return (
    <section id="projects" className="py-16 border-t border-white/8">
      ...
      <div className="grid grid-cols-3 gap-3" style={{ overflow: 'visible' }}>
        ...
        {/* Project one */}
        <div className="bg-[#161616] border border-white/7 rounded-xl overflow-hidden flex flex-col
          ...
          <div className="p-6 flex flex-col gap-3 flex-1">
            ...
            <p className="text-xs text-white/40 leading-relaxed flex-1">A Next.js Pokedex app that lets you browse and search all Pokemon.</p>
            <div className="flex justify-between items-center pt-3 border-t border-white/7">
              ...
              <a href="https://next-pokedex-neon.vercel.app/" target="_blank" rel="noreferrer" className="text-xs text-white/30 hover:text-white">↗</a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#161616] border border-white/7 rounded-xl p-6 flex flex-col gap-3
          ...
          <p className="text-xs text-white/40 leading-relaxed flex-1">A short description of what this project does and the problem it solves.</p>
          <div className="flex justify-between items-center pt-3 border-t border-white/7">
            <span className="text-[11px] text-[#e07b39]">React</span>
            <a href="https://highcaliber-project.vercel.app/" target="_blank" rel="noreferrer" className="text-xs text-white/30 hover:text-white">↗</a>
          </div>
        </div>
        ...
        <div className="bg-[#161616] border border-white/7 rounded-xl p-6 flex flex-col gap-3
          ...
          <div className="flex justify-between items-center pt-3 border-t border-white/7">
            ...
            <a href="#" target="_blank" rel="noreferrer" className="text-xs text-white/30 hover:text-white">↗</a>
          </div>
        </div>
